...
# Load batch file
imgDir = '/Users/Claire/Documents/ec/resubmit/green/ESCC_ML-master/example/images'
...
for ind in range(len(dirlist)):
    ...
    params = '/Users/Claire/Documents/ec/resubmit/green/ESCC_ML-master/Feature Extraction/Paramsescc.yaml'
...
dataframe.to_csv('/Users/Claire/Documents/ec/resubmit/green/ESCC_ML-master/Expected results/Features_Radiomics.csv')