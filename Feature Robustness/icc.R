...
setwd("/Users/Claire/Documents/ec/resubmit/green/ESCC_ML-master/example")
...
write.csv(dt, file="/Users/Claire/Documents/ec/resubmit/green/ESCC_ML-master/Expected results/Features_icc.csv")
